...
export default function LoginPage() {
  ...
  const handleDevLogin = async () => {
    ...
    try {
      ...
      // แก้ตรงนี้
      const { accessToken, refreshToken, user, permissions } = res.data
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-emerald-100 dark:from-gray-900 dark:to-gray-800">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 w-full max-w-sm">
        ...
        {/* LINE Login Button */}
        <button
          onClick={() => alert('LINE LIFF — จะเชื่อมใน Production')}
          className="w-full bg-[#06C755] hover:bg-[#05b34c] text-white font-semibold py-3 px-4 rounded-xl flex items-center justify-center gap-3 mb-4 transition"
        >
